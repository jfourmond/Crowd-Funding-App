			...
			<main class="mdl-layout__content">
				<div class="mdl-card mdl-shadow--6dp">
					<div class="mdl-card__title mdl-color--primary mdl-color-text--white">
						<h2 class="mdl-card__title-text">Commentaire</h2>
					</div>
					<div class="mdl-card__supporting-text">
						<form method="post" action="project_add">
							...
							<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
								<input class="mdl-textfield__input" type="text" id="id" name="id" pattern="([0-9])+" required />
								<label class="mdl-textfield__label" for="id">ID du projet</label>
								<span class="mdl-textfield__error">${form.errors['id']}</span>
							</div>
							<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
							...
							<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
								...
								<label class="mdl-textfield__label" for="goal">Date de dernière mise à jour</label>
